class MailTemplates {
    ...
    private emailFooter(): string {
      return `
        ...
        <p style="font-size: 14px; color: #888; text-align: center;">
          For any questions, contact our support team at <a href="mailto:support@EventEase.com" style="color: #9747FF;">support@EventEase.com</a>.
        </p>
    ...
    resetPasswordTemplate(name: string, resetPassLink: string): string {
      const content = `
        ...
        <p style="font-size: 16px;">We received a request to reset your password for your EventEase account. If you did not request this change, please disregard this email. If you did, you can reset your password by clicking the button below:</p>
    ...
    emailVerificationTemplate(
      ...
      const content = `
        <p style="font-size: 16px;">Hello ${name},</p>
        <p style="font-size: 16px;">Thank you for signing up with EventEase. To complete your registration, please verify your email address by clicking the button below.</p>
        ${this.button('Verify Email Address', emailVerificationLink)}
        <p style="font-size: 16px;">If you didn’t sign up for EventEase, please ignore this email. If you need assistance, feel free to contact us.</p>
        ${this.emailFooter()}
      `
      return this.emailContainer(content)
    }
